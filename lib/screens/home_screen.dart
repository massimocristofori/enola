...
// ── Folder Cover Grid — cover images ─────────────────────────────────────────
     ...
     child: StreamBuilder<TrainingSession?>(
       ...
       builder: (context, trainingSnap) {
         ...
         return LongPressDraggable<RiddleMap>(
           ...
           feedback: SizedBox(
             // Match the 3-column card width: (maxWidth - 2×40 padding - 2×16 gaps) / 3
 ...
 Widget build(BuildContext context) {
   return Container(
     ...
     child: Column(
       ...
       mainAxisSize: MainAxisSize.min,
       children: [
         // Title row — 34px (slightly shorter for 3-col density)
         Container(
           height: 34,
           padding:
